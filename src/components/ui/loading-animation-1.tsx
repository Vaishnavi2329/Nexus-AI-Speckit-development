...
const ConcentricRingsLoader = ({ 
  ...
  return (
    <div className="concentric-rings-loader flex flex-col items-center justify-center">
      <canvas ref={canvasRef} className="block" />
      {showText && (
        <div className="loader-text mt-4 text-sm font-medium text-muted-foreground animate-pulse">
          {text}
        </div>
      )}
    </div>
